...
public class MyPhotoView extends SimpleDraweeView implements IAttacher {

    private Attacher mAttacher;

    private boolean mEnableDraweeMatrix = true;

    public MyPhotoView(Context context, GenericDraweeHierarchy hierarchy) {
    ...
    public void setPhotoUri(String uri) {
        setPhotoUri(Uri.parse(uri), null);
    }
